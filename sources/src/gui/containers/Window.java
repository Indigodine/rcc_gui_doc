...
public class Window extends JFrame {
	...
	public Window() {
		...
		try {
			...
			if (Common.myClientSOAP.isExpExist()) splashScreen.step(1, true);
			else if (Common.myClientSOAP.creerExperience(Common.getRCCName(), Common.getPath())) splashScreen.step(2, true);
