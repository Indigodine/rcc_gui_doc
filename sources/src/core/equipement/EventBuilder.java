...
public class EventBuilder extends Actor
{
	public EventBuilder(Window frame, String nomEquipement, String nomHost, String log_level, String container) {
		super(frame, nomEquipement, "gnarval_ebyedat_merger", nomHost, log_level, container);
		type = EquipementType.EVENTBUILDER;
	}
	...
	public void openModificationPanel() {
		...
		final JTextField blockSizeField = new JTextField(Integer.toString(Common.myClientSOAP.readEventBuilderBlockSize(name)));
		...
		blockSizeField.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				Common.myClientSOAP.writeEventBuilderBlockSize(name, newBlockSize);
				frame.getContentPanel().getGrid().repaint();
			}
		});
...
*/
		boutonUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				blockSizeField.setText( Integer.toString( Common.myClientSOAP.readEventBuilderBlockSize(name) ) );
				jcbWatcher.setSelected( Common.myClientSOAP.readWatcher(name) );
		...
		boutonClose.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int newBlockSize = Integer.parseInt(blockSizeField.getText());
				int blockSize = Common.myClientSOAP.readEventBuilderBlockSize(name);
				if (blockSize != newBlockSize) Common.myClientSOAP.writeEventBuilderBlockSize(name, newBlockSize);
				frame.getContentPanel().getGrid().repaint();
				dialog.dispose();
			}
		});
